...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Extension">
      <sch:assert test="count(f:extension[@url = 'startVisitId']) &lt;= 1">extension with URL = 'startVisitId': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'endVisitId']) &lt;= 1">extension with URL = 'endVisitId': maximum cardinality of 'extension' is 1</sch:assert>
