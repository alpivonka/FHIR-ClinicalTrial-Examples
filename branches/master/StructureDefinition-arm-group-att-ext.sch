...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Extension">
      <sch:assert test="count(f:extension[@url = 'randomizationWeight']) &lt;= 1">extension with URL = 'randomizationWeight': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'soa']) &lt;= 1">extension with URL = 'soa': maximum cardinality of 'extension' is 1</sch:assert>
