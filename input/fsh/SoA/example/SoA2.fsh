...
* action[+].type = SoAActionCS#ACTIVITIES
...
* action[=].action[=].extension[EpochId].valueUri = "PlanDefinition/EPCH-DEF-0002-2/#Treatment-65e9-11ed-9022-0242ac120001"
//RelatedAction
...
* action[=].action[=].extension[EpochId].valueUri = "PlanDefinition/EPCH-DEF-0002-2/#Followup-65e9-11ed-9022-0242ac120000"
* action[=].action[=].relatedAction[+].targetId = "Visit-V1"
* action[=].action[=].relatedAction[=].relationship = #after
* action[=].action[=].relatedAction[+].targetId = "Visit-V2"
* action[=].action[=].relatedAction[=].relationship = #after
...
* action[+].type = SoAActionCS#UNSCHEDULED_ACTIVITIES
...
//ADHOC_FORMS
* action[+].type = SoAActionCS#ADHOC_FORMS
